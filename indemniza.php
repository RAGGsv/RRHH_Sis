	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.edit_employee').click(function(){
				...
				uni_modal("Editar","manage_employee.php?id="+$id)
				
			});
			$('.view_employee').click(function(){
				var $id=$(this).attr('data-id');
				uni_modal("Detalles","view_employee.php?id="+$id,"mid-large")
				
			});
			$('#new_emp_btn').click(function(){
				uni_modal("Nuevo","manage_employee.php")
			})
			$('.remove_employee').click(function(){
				_conf("¿Quieres borrar este empleado?","remove_employee",[$(this).attr('data-id')])
			})
		});
