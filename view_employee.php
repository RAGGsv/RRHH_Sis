...
<div class="contriner-fluid">
	<div class="col-md-12">
		<h5><b><small>ID de Empleado :</small><?php echo $employee_no ?></b></h5>
		<h4><b><small>Nombre: </small><?php echo ucwords($lastname.", ".$firstname." ",$middlename) ?></b></h4>
		<p><b>Departamento : <?php echo ucwords($dname) ?></b></p>
		<p><b>Posicion : <?php echo ucwords($pname) ?></b></p>
		<hr class="divider">
		<div class="row">
			<div class="col-md-6">
				<div class="card">
