			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						<span><b>Lista de Planilla</b></span>
						<button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button" id="new_payroll_btn"><span class="fa fa-plus"></span> Agregar Planilla</button>
					</div>
					<div class="card-body">
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<?php if($row['status'] == 0): ?>
									<td class="text-center"><span class="badge badge-primary">Nuevo</span></td>
									<?php else: ?>
									<td class="text-center"><span class="badge badge-success">Calculado</span></td>
									<?php endif ?>
									<td>
										<center>
									<?php if($row['status'] == 0): ?>
										 <button class="btn btn-sm btn-outline-primary calculate_payroll" data-id="<?php echo $row['id']?>" type="button">Calcular</button>
									<?php else: ?>
