			...
			<form action="" id="manage-department">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary save"> Guardar</button>
								<button class="btn btn-sm btn-danger cancel" type="button" onclick="_reset()"> Cancelar</button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Departmento</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_department" type="button" data-id="<?php echo $row['id'] ?>">Borrar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	function delete_department($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Borrado con éxito",'success')
					setTimeout(function(){
						location.reload()
					},1500)
